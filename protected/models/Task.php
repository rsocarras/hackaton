...
class Task extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('assign, users_id, projects_id', 'numerical', 'integerOnly'=>true),
			array('title, description, status', 'length', 'max'=>45),
			array('due_date, datecreate, datemodify', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, description, due_date, datecreate, datemodify, status, assign, users_id, projects_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'assign0' => array(self::BELONGS_TO, 'Users', 'assign'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('assign',$this->assign);
